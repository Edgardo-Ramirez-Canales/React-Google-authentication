  ...
  return (
    <Container>
      ...
      <div className="details">
        <h1 className="title">Autenticado correctamente</h1>
        <p className="description">Bienvenido a la aplicación de ejemplo</p>
      </div>
      <DatosUser />
    </Container>
  );
...
const Container = styled.div`
  background-image: linear-gradient(to right bottom, #1cc561, #17ab55, #149148, #11783c, #0e6030);
  margin: -20px;
  display: flex;
  align-items: center;
  gap: 1rem;
